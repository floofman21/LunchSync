    ...
    <article className="card-hero">
      ...
      <div className="block">
        ...
        {lunch.restaurant ? (
          ...
          <>
            <div className="hint">no spot picked yet — vote for one or just lock it in</div>
      ...
      <div className="block">
        ...
        <textarea
          className="notes"
          placeholder="reservation needed? someone's bringing a guest? leave a note…"
          value={lunch.notes || ''}
...
function FutureCard({ lunch, me, setRsvp }) {
  ...
  return (
    <div className="future-card">
      ...
      <div className="future-yes">{yesCount > 0 ? `${yesCount} in` : 'no rsvps yet'}</div>
